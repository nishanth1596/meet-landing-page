...
const Info = () => {
  return (
    <section className="relative mx-8 mt-8 mb-16 text-center md:mx-11">
      ...
      <h2 className="text-Slate-900 mt-4 text-[2rem] leading-[1.1] font-black md:mx-[7.47rem] md:text-4xl lg:mx-[29.1rem] lg:text-[2.5rem]">
        Smarter meetings, all in one place
      </h2>

      <p className="text-Slate-600 mt-8 text-base leading-6 font-medium md:mx-[5.63rem] lg:mx-[26rem] lg:text-lg">
